package net.pdp7.meetcontroller.web;
...
public final class MQTTServer {
	...
	static class PublisherListener extends AbstractInterceptHandler {
		...
		public void onPublish(InterceptPublishMessage msg) {
			...
			final String decodedPayload = new String(bytes, UTF_8);
	...
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		MqttPublishMessage message = MqttMessageBuilders.publish().topicName("/exit").retained(true)
//        qos(MqttQoS.AT_MOST_ONCE);
//        qQos(MqttQoS.AT_LEAST_ONCE);
				.qos(MqttQoS.EXACTLY_ONCE).payload(Unpooled.copiedBuffer("Hello World!!".getBytes(UTF_8))).build();
